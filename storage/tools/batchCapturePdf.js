// tools/batchCapturePdf.js
// Batch test runner for "Universal Invoice Parser" milestone.
// Usage:
//   node tools/batchCapturePdf.js ./fixtures/invoices --ocr=true --maxPages=4
...
async function main() {
  ...
  if (!folder) {
    console.log("Provide a folder path with PDFs. Example:");
    console.log("  node tools/batchCapturePdf.js ./fixtures/invoices --ocr=true --maxPages=4");
    process.exit(1);
  }
  ...
  console.log("Run folder:", path.relative(process.cwd(), outDir));
}
